...
export default function Navbar() {
  return (
    <div className="w-full border-b-2 border-theme-1-cerulean  dark:border-theme-1-cerulean">
        {/* <SignOutButton /> */}
        ...
        backdrop-blur-xl shadow-b-md">
            ...
            <Link href="/" className="text-theme-1-cerulean hover:opacity-90 no-underline">sudokyou.org</Link>
            </h1>
            ...
            {/* <Link className="hidden md:block lg:block" href="https://github.com/ashvinbondada/sudokyou.org">
                <FaGithub className="dark:text-dun text-theme-1-cerulean hover:opacity-90"/>
            </Link> */}
            {/* <SignInButton /> */}
            </div>
        </nav>
