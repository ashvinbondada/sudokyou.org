...
//     <div className="w-full border-b-2 border-theme-2-berkeley-blue dark:border-b-anti-flash-white">
//       {/* <SignOutButton /> */}
//       <nav className="xl:w-[1280px] lg:w-[1024px] px-1 h-16 mx-auto flex justify-between sticky top-0 dark:bg-smoky-black backdrop-blur-xl shadow-b-md text-theme-2-berkeley-blue">
//         <div className="flex items-center">
//           <img
//             src="/icon.png"
//             alt="Sudokyou Logo"
//             className="w-8 h-8 mr-2" // Adjust the size as needed (8 for width and height means 32px)
//           />
//           <h1 className="text-3xl font-bold text-white mb-2 md:mb-0">
//             <Link
//               href="/"
//               className="dark:text-dun text-theme-2-berkeley-blue hover:opacity-90 no-underline"
//             >
//               sudokyou.org
//             </Link>
//           </h1>
