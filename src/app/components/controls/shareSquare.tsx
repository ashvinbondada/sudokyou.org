  ...
  return (
    // <div className="w-full h-full">
        <div className="w-full h-full bg-white flex items-center justify-center">
          <div className="w-full h-full flex flex-col items-center justify-center lg:text-4xl md:text-3xl sm:text-xl select-none transition-all duration-300 hover:bg-theme-1-pacific-cyan bg-gray-100 relative group hover:shadow-custom-inner text-theme-1-pacific-cyan hover:text-white">
